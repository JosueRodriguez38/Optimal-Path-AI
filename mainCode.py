...
PR_map = search.Map({('Ponce', 'Salinas'): arrivalTime(36, 50, trafficType[0]),
                     ('Ponce', 'Adjuntas'): arrivalTime(25, 40, trafficType[2]),
                     ('Ponce', 'Yauco'): arrivalTime(32, 55, trafficType[0]),
                     ('Mayaguez', 'Yauco'): arrivalTime(45, 55, trafficType[0]),
                     ('Mayaguez', 'Maricao'): arrivalTime(26, 40, trafficType[1]),
                     ...
                     ('Camuy', 'Aguadilla'): arrivalTime(39, 50, trafficType[0]),
                     ('Camuy', 'Utuado'): arrivalTime(44, 40, trafficType[2]),
                     ('Camuy', 'Arecibo'): arrivalTime(15, 50, trafficType[0]),
                     ('Utuado', 'Arecibo'): arrivalTime(33, 50, trafficType[1]),
                     ('Utuado', 'Adjuntas'): arrivalTime(21, 35, trafficType[2]),
